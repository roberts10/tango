...
QueryBuilder.OPERATORS = {
    ...
    regexp:           { type: 'regexp',           nb_inputs: 1, multiple: false, apply_to: ['string'] },
    not_regexp:       { type: 'not_regexp',       nb_inputs: 1, multiple: false, apply_to: ['string'] },
    is_empty:         { type: 'is_empty',         nb_inputs: 0, multiple: false, apply_to: ['string'] },
    is_not_empty:     { type: 'is_not_empty',     nb_inputs: 0, multiple: false, apply_to: ['string'] },
    is_null:          { type: 'is_null',          nb_inputs: 0, multiple: false, apply_to: ['string', 'number', 'datetime', 'boolean'] },
    is_not_null:      { type: 'is_not_null',      nb_inputs: 0, multiple: false, apply_to: ['string', 'number', 'datetime', 'boolean'] },
    fulltext:         { type: 'fulltext',         nb_inputs: 1, multiple: false, apply_to: ['string'] }
...
QueryBuilder.defaults({
    ...
    sqlOperators: {
        ...
        fulltext:         { op: 'AGAINST ( ? IN BOOLEAN MODE)',  mod: '"{0}"'},
        is_empty:         { op: '= \'\'' },
        is_not_empty:     { op: '!= \'\'' },
        is_null:          { op: 'IS NULL' },
